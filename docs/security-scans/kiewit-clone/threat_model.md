...
- Infrastructure hosting controls not represented in the repository.
- Formspree account-side rules.
- GA4 property/account settings.
- Future backend, CRM, or AI API integrations not present in the current code.
